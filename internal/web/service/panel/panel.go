...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/sllikmll/unified-vpn-panel/main/update.sh"
...
func fetchPanelRelease(tag string) (*service.Release, error) {
	url := "https://api.github.com/repos/sllikmll/unified-vpn-panel/releases/latest"
	if tag != "" {
		url = "https://api.github.com/repos/sllikmll/unified-vpn-panel/releases/tags/" + tag
	}
