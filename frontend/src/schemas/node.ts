...
export const NodeRecordSchema = z.object({
  ...
  memCurrent: z.number().optional(),
  memTotal: z.number().optional(),
  memPct: z.number().optional(),
  swapCurrent: z.number().optional(),
  ...
  netTrafficSent: z.number().optional(),
  netTrafficRecv: z.number().optional(),
  tcpCount: z.number().optional(),
  udpCount: z.number().optional(),
  appStatsMem: z.number().optional(),
  appStatsThreads: z.number().optional(),
  appStatsUptime: z.number().optional(),
