...
of the shipped panel — nothing here is embedded into the Go binary. The built Storybook is published by `.github/workflows/docs-deploy.yml`; the workflow and deployment status live in the project repository.
