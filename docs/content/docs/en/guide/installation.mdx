...
[releases page](https://github.com/sllikmll/unified-vpn-panel/releases), extract it, and run
...
The repo's [`deploy/`](https://github.com/sllikmll/unified-vpn-panel/tree/main/deploy)
