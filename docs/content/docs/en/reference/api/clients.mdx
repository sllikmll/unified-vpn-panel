...
_openapi:
  ...
  toc:
    ...
    - depth: 2
      title: List all client groups/squads with their member counts, metadata,
        assigned inbound IDs and optional default traffic/expiry policy.
        Membership is still the existing clients.group_name label; no second
        squad membership table is introduced.
      url: '#list-all-client-groupssquads-with-their-member-counts-metadata-assigned-inbound-ids-and-optional-default-trafficexpiry-policy-membership-is-still-the-existing-clientsgroup_name-label-no-second-squad-membership-table-is-introduced'
    - depth: 2
    ...
    - depth: 2
      title: Create a new group/squad row with optional description, enabled status,
        assigned inbound IDs and traffic/expiry defaults. Assigned inbounds are
        applied to current members through the client service runtime path.
      url: '#create-a-new-groupsquad-row-with-optional-description-enabled-status-assigned-inbound-ids-and-trafficexpiry-defaults-assigned-inbounds-are-applied-to-current-members-through-the-client-service-runtime-path'
    - depth: 2
      title: Update group/squad metadata and assignments. If name changes, the
        existing group label is renamed; assigned inbound membership and policy
        defaults are applied through runtime-aware client operations.
      url: '#update-groupsquad-metadata-and-assignments-if-name-changes-the-existing-group-label-is-renamed-assigned-inbound-membership-and-policy-defaults-are-applied-through-runtime-aware-client-operations'
    - depth: 2
    ...
    - depth: 2
      title: Reapply a group/squad assigned-inbound and policy-default configuration
        to current members. This is useful after importing clients or repairing
        drift; all client changes go through runtime-aware client operations.
      url: '#reapply-a-groupsquad-assigned-inbound-and-policy-default-configuration-to-current-members-this-is-useful-after-importing-clients-or-repairing-drift-all-client-changes-go-through-runtime-aware-client-operations'
    - depth: 2
  ...
  structuredData:
    headings:
      ...
      - content: List all client groups/squads with their member counts, metadata,
          assigned inbound IDs and optional default traffic/expiry policy.
          Membership is still the existing clients.group_name label; no second
          squad membership table is introduced.
        id: list-all-client-groupssquads-with-their-member-counts-metadata-assigned-inbound-ids-and-optional-default-trafficexpiry-policy-membership-is-still-the-existing-clientsgroup_name-label-no-second-squad-membership-table-is-introduced
      ...
      - content: Create a new group/squad row with optional description, enabled status,
          assigned inbound IDs and traffic/expiry defaults. Assigned inbounds
          are applied to current members through the client service runtime
          path.
        id: create-a-new-groupsquad-row-with-optional-description-enabled-status-assigned-inbound-ids-and-trafficexpiry-defaults-assigned-inbounds-are-applied-to-current-members-through-the-client-service-runtime-path
      - content: Update group/squad metadata and assignments. If name changes, the
          existing group label is renamed; assigned inbound membership and
          policy defaults are applied through runtime-aware client operations.
        id: update-groupsquad-metadata-and-assignments-if-name-changes-the-existing-group-label-is-renamed-assigned-inbound-membership-and-policy-defaults-are-applied-through-runtime-aware-client-operations
      ...
      - content: Reapply a group/squad assigned-inbound and policy-default configuration
          to current members. This is useful after importing clients or
          repairing drift; all client changes go through runtime-aware client
          operations.
        id: reapply-a-groupsquad-assigned-inbound-and-policy-default-configuration-to-current-members-this-is-useful-after-importing-clients-or-repairing-drift-all-client-changes-go-through-runtime-aware-client-operations
