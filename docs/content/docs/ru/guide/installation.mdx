...
[страницы релизов](https://github.com/sllikmll/unified-vpn-panel/releases), распаковать его и
...
В каталоге [`deploy/`](https://github.com/sllikmll/unified-vpn-panel/tree/main/deploy)
