...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/sllikmll/unified-vpn-panel/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_dev() {
    ...
    XUI_UPDATE_TAG="dev-latest" bash <(curl -Ls https://raw.githubusercontent.com/sllikmll/unified-vpn-panel/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    if replace_xui_script "https://raw.githubusercontent.com/sllikmll/unified-vpn-panel/main/x-ui.sh" "false"; then
...
legacy_version() {
    ...
    # Always fetch the maintained installer from main; pass the requested release tag to it.
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/sllikmll/unified-vpn-panel/main/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/sllikmll/unified-vpn-panel/main/install.sh)${plain}"
    echo ""
...
update_shell() {
    if replace_xui_script "https://github.com/sllikmll/unified-vpn-panel/raw/main/x-ui.sh" "true"; then
