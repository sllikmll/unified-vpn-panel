...
Para instalar una versión específica, añade su etiqueta (p. ej. `v0.0.1`):
...
Para la documentación completa, visita la [Wiki del proyecto](https://github.com/sllikmll/unified-vpn-panel/wiki).
